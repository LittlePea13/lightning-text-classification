...
from classifier_siamese import Classifier
...
def main(hparams) -> None:
    ...
    # To load a pre-trained chheckpoint:
    # model = Classifier.load_from_checkpoint('experiments/version_28-09-2020--00-13-20/checkpoints/epoch=1.ckpt', hparams)
    ...
    # 6 START TRAINING
    # ------------------------
    # Comment next line if only want to test model:
