...
class Classifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        # Tokenizer
        self.tokenizer = AutoTokenizer.from_pretrained("bert-base-uncased")#Tokenizer("bert-base-uncased")
    ...
    def forward(self, inputs):
        ...
        return {"logits": self.classification_head(outputs[0][:, 0, :])}
    ...
    def prepare_sample(self, sample: list, prepare_target: bool = True) -> (dict, dict):
        ...
        inputs = self.tokenizer(sample["text_en"],
            return_tensors="pt", 
            padding=True, 
            #return_length=True, 
